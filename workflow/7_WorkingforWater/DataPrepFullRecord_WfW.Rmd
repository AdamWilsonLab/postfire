...
```{r setup1,echo=F,results='hide', warning=FALSE, message=FALSE, cache = F}
...
```{r veg2,htmlcap="Land cover types aggregated to the 30m grid", warning=FALSE, message=FALSE, cache = F}
...
```{r vegc, warning=FALSE, message=FALSE, cache = F}
...
```{r loadLandsat, warning=FALSE, message=FALSE, cache = F}
...
```{r landsatplot, fig.width=7, fig.height=6, warning=FALSE, message=FALSE, cache = F}
...
```{r landsateras,fig.cap="Timeline of LANDSAT data by sensor",fig.height=3, warning=FALSE, message=FALSE, cache = F}
...
```{r ndviplot,fig.cap="Merged annual maximum LANDSAT NDVI", warning=FALSE, message=FALSE, cache = F}
...
```{r fire3, warning=FALSE, message=FALSE, cache = F}
...
``` {r join, warning=FALSE, message=FALSE, cache = F}
...
``` {r plots1, echo=FALSE,warning=FALSE,message=FALSE, fig.width = 16, fig.height=12}
#playing with plots
...
``` {r plots2, echo=FALSE,warning=FALSE,message=FALSE, fig.width = 16, fig.height=12}
...
``` {r plots3, echo=FALSE,warning=FALSE,message=FALSE, fig.width = 16, fig.height=12}
#with vlines
...
read vertical lines show clearing, purple vertical lines show fires
``` {r plots4, echo=FALSE,warning=FALSE,message=FALSE, fig.width = 16, fig.height=12}
...
showing only L5
``` {r plots5, echo=FALSE,warning=FALSE,message=FALSE, fig.width = 16, fig.height=12}
...
showing only L5
``` {r plots6, echo=FALSE,warning=FALSE,message=FALSE, fig.width = 16, fig.height=12}
# or by veg type
...
showing only L5
``` {r plots7, echo=FALSE,warning=FALSE,message=FALSE, fig.width = 16, fig.height=12}
...
showing only L5
``` {r plots8, echo=FALSE,warning=FALSE,message=FALSE, fig.width = 16, fig.height=12}
...
```{r,echo=FALSE,eval=FALSE,results='hide',message=FALSE,error=FALSE}
