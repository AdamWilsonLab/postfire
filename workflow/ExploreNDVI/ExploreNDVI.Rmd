...
```{r}
# LANDSAT 5
L5=stack(paste0(datadir,"raw/NDVI/20140722_1b93885d00_LT5_L1T_ANNUAL_GREENEST_TOA__1985-2012-0000000000-0000000000.tif"))
NAvalue(L5)=-32768
...
# LANDSAT 7
# L7=stack(paste0(datadir,"raw/NDVI/20140718_1b93885d00_LE7_L1T_ANNUAL_GREENEST_TOA__1999-2014-0000000000-0000000000.tif"))
# NAvalue(L7)=0
# gain(L7)=.01
...
# 
# # LANDSAT 8
# L8=stack(paste0(datadir,"raw/NDVI/20140718_1b93885d00_LC8_L1T_ANNUAL_GREENEST_TOA__2013-2014-0000000000-0000000000.tif"))
# gain(L8)=.01
# NAvalue(L8)=0
...
```{r}
plot(c(L5[199165])~getZ(L5),type="l",ylab="NDVI",xlab="Year")
```
